...
const COMMON_SKILLS = [
  'React', 'Python', 'AI/ML', 'Cloud', 'Mobile', 
  'DevOps', 'UX/UI', 'Cybersecurity', 'Data Science', 
  'Blockchain', 'IoT', 'Node.js', 'AWS', 'TypeScript',
...
const ProfileCardBuilder = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    if (formData.email) {
      localStorage.setItem('compass_community_waitlist', JSON.stringify(formData))
      setSubmitted(true)
    }
  }
        ...
        <div className="min-h-[350px]">
          {step === 1 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              <h2 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Basic Info</h2>
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-300 bg-white/50 px-4 py-2 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 dark:border-gray-600 dark:bg-gray-900/50 dark:text-white"
                    placeholder="Jane Doe"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Title / Position</label>
                  <input
                    type="text"
                    name="title"
          ...
          {step === 2 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              <h2 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Skills & Interests</h2>
          ...
          {step === 3 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              <h2 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Social Links & Bio</h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Short Bio / Tagline</label>
                  <textarea
                    name="bio"
                    value={formData.bio}
                    onChange={handleChange}
                    rows={2}
                    className="w-full rounded-xl border border-gray-300 bg-white/50 px-4 py-2 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 dark:border-gray-600 dark:bg-gray-900/50 dark:text-white resize-none"
          ...
          {step === 4 && (
            <div className="animate-in fade-in slide-in-from-right-4 duration-500">
              <h2 className="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Love your card?</h2>
              <p className="mb-6 text-gray-600 dark:text-gray-400">
                Join the waitlist to claim your profile when we launch the full community platform.
              </p>
              
              {submitted ? (
                <div className="rounded-2xl bg-green-50 p-6 text-center border border-green-200 dark:bg-green-900/20 dark:border-green-800">
                  <h3 className="text-lg font-semibold text-green-800 dark:text-green-400 mb-2">You're on the list! 🎉</h3>
                  <p className="text-green-700 dark:text-green-500 text-sm">
                    We've saved your profile preview. We'll email you when the platform goes live!
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full rounded-xl border border-gray-300 bg-white/50 px-4 py-3 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 dark:border-gray-600 dark:bg-gray-900/50 dark:text-white"
