...
const TEMPLATES = [
  {
    ...
    blocks: [
      ...
      },
      {
        id: 'b3',
        type: 'button',
        content: { text: 'View All Events', url: '#', color: '#6366f1' },
      },
    ...
    blocks: [
      {
        ...
        content: {
          ...
          subtitle: 'Meet our featured speaker',
          bg: '#6366f1',
        },
      },
      {
      ...
      },
      {
        ...
        type: 'text',
        content: {
          text: 'Jane will be talking about the future of web development.',
        },
      },
      {
        id: 'b4',
        type: 'button',
        content: { text: 'Register to Watch', url: '#', color: '#efb403' },
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        type: 'text',
        content: {
          text: 'Here are the latest updates from our community this month.',
        },
      },
      {
        id: 'b3',
        ...
        content: {
          ...
          caption: 'Last months meetup',
        },
      },
      {
        id: 'b4',
        type: 'text',
        content: { text: 'Thank you to everyone who attended!' },
      },
...
export default function NewsletterStudioPage() {
  ...
  const handleLoadTemplate = (template) => {
    ...
    setBlocks(
      JSON.parse(JSON.stringify(template.blocks)).map((b) => ({
        ...b,
  ...
  const renderBlockPreview = (block) => {
    switch (block.type) {
      case 'header':
        return (
          <div
            style={{ backgroundColor: block.content.bg }}
      ...
      case 'speaker':
        return (
          <div className="p-6 flex items-center gap-4 bg-gray-50 mx-6 rounded-lg my-2 border border-gray-100">
            <img
      ...
      case 'event':
        return (
          <div className="p-6 mx-6 bg-white border border-gray-200 shadow-sm rounded-lg my-2 text-center">
            ...
            <button className="bg-primary text-gray-900 font-bold py-2 px-6 rounded-md">
              {block.content.cta}
            </button>
          </div>
        )
        ...
        return (
          <div className="px-6 py-4 text-center">
            <a
              ...
              className="inline-block py-3 px-8 text-white font-bold rounded-md no-underline"
            >
              {block.content.text}
            </a>
          </div>
      ...
      case 'divider':
        return (
          <hr
            style={{
              borderTopStyle: block.content.style,
      ...
      case 'social':
        return (
          <div className="p-6 text-center flex justify-center gap-4">
            <span
              className="size-10 bg-gray-200 rounded-full flex items-center justify-center text-gray-600 font-bold text-xs"
              aria-label="LinkedIn"
            >
              IN
            </span>
          ...
          <>
            <div>
              <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">
                ...
                <input
                  ...
                  className="mt-1 w-full rounded border px-3 py-2 text-sm dark:bg-gray-800 dark:border-gray-700"
                />
              </label>
            </div>
            <div>
            ...
            <div>
              <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">
                ...
                <input
                  type="color"
                  value={block.content.bg}
                  onChange={(e) =>
                    updateBlockContent(block.id, { bg: e.target.value })
                  }
                  className="mt-1 w-full rounded border h-10"
                />
              </label>
            </div>
          </>
            ...
            <div>
              <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateBlockContent(block.id, { color: e.target.value })
                  }
                  className="mt-1 w-full rounded border h-10"
                />
              </label>
            ...
            <div>
              <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateBlockContent(block.id, { name: e.target.value })
                  }
                  className="mt-1 w-full rounded border px-3 py-2 text-sm dark:bg-gray-800 dark:border-gray-700"
                />
              </label>
            ...
            <div>
              <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateBlockContent(block.id, { avatar: e.target.value })
                  }
                  className="mt-1 w-full rounded border px-3 py-2 text-sm dark:bg-gray-800 dark:border-gray-700"
                />
              </label>
            ...
            <div>
              <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateBlockContent(block.id, { date: e.target.value })
                  }
                  className="mt-1 w-full rounded border px-3 py-2 text-sm dark:bg-gray-800 dark:border-gray-700"
                />
              </label>
            ...
            <div>
              <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateBlockContent(block.id, { location: e.target.value })
                  }
                  className="mt-1 w-full rounded border px-3 py-2 text-sm dark:bg-gray-800 dark:border-gray-700"
                />
              </label>
            ...
            <div>
              <label className="block text-sm text-gray-600 dark:text-gray-400 mb-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateBlockContent(block.id, { cta: e.target.value })
                  }
                  className="mt-1 w-full rounded border px-3 py-2 text-sm dark:bg-gray-800 dark:border-gray-700"
                />
              </label>
          ...
          <div className="h-14 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex items-center justify-between px-4 z-10">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 rounded-md"
              >
                <FaFolderOpen /> Load
              </button>
              <button
                onClick={handleSaveDraft}
                className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium bg-primary text-gray-900 rounded-md hover:brightness-105"
              >
                <FaSave /> Save
              </button>
            </div>
                ...
                <div className="pb-20">
                  {blocks.map((block, index) => (
                    ...
                    >
                      ...
                      <div
                        className={`absolute right-[-40px] top-2 flex-col gap-1 hidden group-hover:flex ${
                          activeBlock === block.id ? '!flex' : ''
                        }`}
                      >
                        <button
                          onClick={(e) => {
                            e.stopPropagation()
                            handleMoveBlock(index, -1)
                          }}
                          className="p-1.5 bg-white dark:bg-gray-800 rounded shadow text-gray-600 hover:text-primary"
                        >
                          <FaArrowUp size={12} />
                        </button>
                        <button
                        ...
                        <button
                          ...
                          className="p-1.5 bg-white dark:bg-gray-800 rounded shadow text-red-500 hover:bg-red-50"
                        >
                          <FaTrash size={12} />
                        </button>
                      </div>
                      ...
                      {activeBlock === block.id && (
                        <div className="absolute inset-0 border-2 border-primary pointer-events-none z-10"></div>
                      )}
                    </div>
                  ))}
                </div>
